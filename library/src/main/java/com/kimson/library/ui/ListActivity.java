...
public abstract class ListActivity<VH extends ListAdapter.ViewHolder, Data, Progress, Result> extends LoaderActivity<Progress, Result> {
    ...
    private ListAdapter<VH, Data> mAdapter = new ListAdapter<VH, Data>() {
        ...
        public VH onCreateViewHolder(ViewGroup parent, int viewType) {
            return ListActivity.this.onCreateViewHolder(parent, viewType);
        }

        @Override
        public void onBindViewHolder(VH holder, int position) {
            ListActivity.this.onBindViewHolder(holder, position);
        }

        @Override
        public long getItemId(int position) {
            return ListActivity.this.getItemId(position);
        }
        ...
        public Data getItem(int position) {
            return ListActivity.this.getItem(position);
        }
    ...
    public void onSupportContentChanged() {
        ...
        mLoadMoreView = (LinearLayout) LayoutInflater.from(this).inflate(R.layout.simple_list_footer, null);
    }
