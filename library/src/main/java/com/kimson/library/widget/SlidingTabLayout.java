        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (tabIconView != null) {
                try {
                    ...
                    Method method = adapter.getClass().getMethod("getPageIconResId", int.class);
                    int resId = ((Integer) method.invoke(adapter, i)).intValue();
                    tabIconView.setImageResource(resId);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
